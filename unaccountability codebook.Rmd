...
**Westlaw Cases Function.R**: a function that loops through westlaw cases and constructs a dataframe with metadata and a sentence containing a nominated keyword

and the function it calls:

**IsolateKey.R**: a function for isolating the keyword
